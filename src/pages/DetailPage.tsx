  ...
  return (
    <div className="max-w-5xl mx-auto p-6 md:p-10 bg-white rounded-xl shadow-lg my-10 border border-gray-100">
      ...
      <div className="relative rounded-xl overflow-hidden shadow-md mb-8 group">
        ...
        {/* <div className="absolute bottom-4 left-4 flex items-center bg-black/70 text-white px-3 py-1 rounded-full text-sm">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
        </svg>
        {property.imagesCount || 12} Photos
      </div> */}
      </div>
      ...
      <section className="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center gap-6">
          ...
          <img 
            src={property.agent.photo || "https://randomuser.me/api/portraits/men/42.jpg"} 
...
//   <div className="max-w-5xl mx-auto p-6 md:p-10 bg-white rounded-xl shadow-lg my-10">
//         {/* Image and Status */}
...
//             <div className="bg-green-600 text-white px-4 py-2 rounded-lg font-semibold text-lg shadow-sm">
...
//         {/* Property Details */}
//         <section className="mb-10 grid grid-cols-2 sm:grid-cols-4 gap-6">
...
//                 <li
//                 key={i}
//                 className="bg-green-100 text-green-700 px-4 py-2 rounded-full font-semibold text-sm shadow-sm"
//                 >
//                 {amenity}
//                 </li>
//             ))}
...
//             <h2 className="text-2xl font-bold mb-4 text-gray-900">Agent Info</h2>
